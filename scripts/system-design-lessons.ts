...
import { arch } from "./architecture-walkthrough";
import { rw, app, code, seq, TS } from "./lesson-snippets";
import {
...
export const systemDesignLessons: L[] = [
  ...
  L(
    ...
    [
      ...
      ...arch("system-multistep-workflow"),
